## DEPENDENCIES: deap, basemap, and basemap-data-hires from deap
import random
from deap import creator, base, tools, algorithms
import gps
import pandas as pd

# Maersk Ocean Freight Services is planning to deliver cars, electronics and 
# clothing to countries in the West Pacific. CEO of Maersk hired you as an AI engineer
# to construct the best route for this purpose. Please make the CEO happy so that you
# can get either a T-shirt or a sports car as a bonus.


## load city data into a dataframe df
countries_file = 'Container_ship_delivery.csv'
